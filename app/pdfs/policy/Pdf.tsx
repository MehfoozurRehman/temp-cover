        ...
        <Page size="LEGAL" style={styles.page}>
          ...
          >
            ...
            >
              ...
              >
                ...
                <View style={{ margin: '10px 0px', display: 'flex', gap: '3px' }}>
                  ...
                  >
                    <Text style={{ textAlign: 'right', width: '30px' }}>II</Text>
                  ...
                  >
                    <Text style={{ textAlign: 'right', width: '30px' }}>III</Text>
                    <Text>Law enforcement (prevention, detection, apprehension and or prosecution of offenders)</Text>
                  </View>
                  <View
                    style={{
                      display: 'flex',
                  ...
                  >
                    <Text style={{ textAlign: 'right', width: '30px' }}>IV</Text>
                    <Text>The provision of government services and or other services aimed at reducing the level and incidence of uninsured driving.</Text>
                  </View>
                </View>
                ...
                <Text style={{ lineHeight: '1.3px' }}>
                  Persons (including his or her appointed representatives) pursuing a claim in respect of a road traffic accident (including citizens of other countries) may also obtain information
                  which is held on the MID. It is vital that the MID holds your correct registration number. If it is incorrectly shown on MID you are at risk of having your vehicle seized by the
                  Police.
                </Text>
              </View>
            </View>
            ...
            >
              ...
              >
                RSEMENTS - only if apply if noted in the ENDORSEMENTS APPLICABLE above
              </Text>
              <Text
                style={{
                  fontFamily: 'Arial',
              ...
              >
                We shall not be responsible to pay the first amount as shown on your schedule of insurance of any claim of or series of claims arising out of one event in respect of which indemnity is
              ...
              >
                It is agreed that the territorial limits as described in section 9 (Territorial Limits and using your vehicle abroad) shall be extended to include the Republic of Ireland for the
            ...
            >
              ...
              >
                Cover has been issued and arranged by First Underwriting Limited under authority granted by Accredited Insurance (Europe) Limited who are authorised and regulated by the Malta
            ...
            >
              ...
              >
                Issued by First Underwriting Ltd for and on behalf of Accredited Insurance (Europe) Limited.
              </Text>
            </View>
          </View>
        </Page>
